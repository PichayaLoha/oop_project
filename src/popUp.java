...
public class popUp implements ActionListener,MouseListener{
    ...
    public JPanel e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,e11,e12,e13,e14,e15,e16,e17,e18,e19,e20,e21,y1,y2,y3;
...
//    private int index;
    ...
    public popUp(){
        ...
        lb1 = new JLabel("บาท"); lb1.setForeground(new Color(100,80,153)); lb1.setFont(new Font("Mitr Light", Font.BOLD, 12));
        ...
        l6 = new JLabel("เงินเดือน"); l6.setForeground(new Color(100,80,153)); l6.setFont(new Font("Mitr Light", Font.PLAIN, 12));
        l7 = new JLabel("สัญชาติ"); l7.setForeground(new Color(100,80,153)); l7.setFont(new Font("Mitr Light", Font.PLAIN, 12));
        l9 = new JLabel("การศึกษา"); l9.setForeground(new Color(100,80,153)); l9.setFont(new Font("Mitr Light", Font.PLAIN, 12));
        l10 = new JLabel("หมายเลขธนาคาร"); l10.setForeground(new Color(100,80,153)); l10.setFont(new Font("Mitr Light", Font.PLAIN, 12));
        l11 = new JLabel("หมายเลขโทรศัพท์"); l11.setForeground(new Color(100,80,153)); l11.setFont(new Font("Mitr Light", Font.PLAIN, 12));
        ...
        f10 = new JTextField(5); f10.setForeground(new Color(56,53,120)); f10.setCaretColor(new Color(247,203,45)); f10.setBackground(new Color(250,244,255)); f10.setSelectedTextColor(new Color(190,18,233)); f10.setFont(new Font("Mitr Light", Font.BOLD, 12));
        ...
        f13 = new JTextField(10); f13.setForeground(new Color(56,53,120)); f13.setCaretColor(new Color(247,203,45)); f13.setBackground(new Color(250,244,255)); f13.setSelectedTextColor(new Color(190,18,233)); f13.setFont(new Font("Mitr Light", Font.BOLD, 12));
...
//        u4 = new JLabel("4"); u4.setForeground(new Color(100,80,153)); u4.setFont(new Font("Mitr Light", Font.PLAIN, 12));
        ...
        y3 = new JPanel(); y3.setOpaque(false);
        t1 = new JLabel("    ");
        t2 = new JLabel("   ");
        t3 = new JLabel("   ");
        t4 = new JLabel("   ");
        ...
        e19.add(t6); e19.add(s3); e19.add(u3); e19.add(s4);
        e19.add(t9); e19.add(s10); e19.add(u6);
        e19.add(t10);e19.add(u7);
