...
public class card_room_booked extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lb_phonenum.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lb_phonenum.setText("Telephone number :");

        lb_date.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lb_date.setText("Check-in date :");
        ...
        tf_name.setText("name : nobita Lnwza");
