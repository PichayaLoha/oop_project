...
public class MainRooms extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cardStatus4 = new rooms.CardStatus();
        cardStatus3 = new rooms.CardStatus();
        cardStatus2 = new rooms.CardStatus();
        cardStatus1 = new rooms.CardStatus();
        pnRoom = new javax.swing.JPanel();
        card_room_empty1 = new rooms.CardRoomEmpty();
        card_room_empty2 = new rooms.CardRoomEmpty();
        card_room_empty3 = new rooms.CardRoomEmpty();
        card_room_empty4 = new rooms.CardRoomEmpty();
        card_room_empty5 = new rooms.CardRoomEmpty();
        card_room_empty6 = new rooms.CardRoomEmpty();
        card_room_empty7 = new rooms.CardRoomEmpty();
        card_room_empty8 = new rooms.CardRoomEmpty();
        card_room_empty9 = new rooms.CardRoomEmpty();
    ...
    private rooms.CardStatus cardStatus1;
    private rooms.CardStatus cardStatus2;
    private rooms.CardStatus cardStatus3;
    private rooms.CardStatus cardStatus4;
    private rooms.CardRoomEmpty card_room_empty1;
    private rooms.CardRoomEmpty card_room_empty2;
    private rooms.CardRoomEmpty card_room_empty3;
    private rooms.CardRoomEmpty card_room_empty4;
    private rooms.CardRoomEmpty card_room_empty5;
    private rooms.CardRoomEmpty card_room_empty6;
    private rooms.CardRoomEmpty card_room_empty7;
    private rooms.CardRoomEmpty card_room_empty8;
    private rooms.CardRoomEmpty card_room_empty9;
