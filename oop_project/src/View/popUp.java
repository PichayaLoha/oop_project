...
//        mu2.addMouseListener(this);
    ...
    private void saveData() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/oopject", "root", ""
        )) {
