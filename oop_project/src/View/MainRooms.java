...
private UserModel userModel;
    ...
    public MainRooms() {
        ...
        setSize(970, 607);
        cardStatus1.setData(new ModelStatus("Rooms", 9)); 
        cardStatus2.setData(new ModelStatus("Room not available", 30));
        cardStatus3.setData(new ModelStatus("Vacant room", 30));
